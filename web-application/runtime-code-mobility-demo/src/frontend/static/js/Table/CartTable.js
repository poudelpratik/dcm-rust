...
import {convertHtmlStringToElement, selectElement, selectElements, stringToNumber,} from '../utils/helpers.js';
import {createTableRowHTMLTemplate} from '../utils/tableRowTemplate.js';
import {decrement_number, increment_number} from '../CodeDistributor/exports.js';
...
export default class CartTable extends Table {
    ...
    increaseQuantity = async (evt, input) => {
        ...
        quantity = await increment_number(quantity);
    ...
    decreaseQuantity = async (evt, input) => {
        ...
        let quantity = stringToNumber(input.value);
        quantity = await decrement_number(quantity);
