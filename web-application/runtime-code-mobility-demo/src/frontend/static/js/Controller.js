...
import {increment_number} from './CodeDistributor/exports.js';
import OrderHistory from "./OrderHistory/index.js";

import {addEventListenerMulti, isUndefined, selectElement, selectElements,} from './utils/helpers.js';
...
export default class Controller {
    ...
    add = async (product) => {
        ...
        if (!isUndefined(cartItem)) {
            let quantity = await increment_number(
                cartItem.quantity
            );
    ...
    saveToHistory = async () => {
        await this.orderHistory.update(this.cart.products);
    };
